...
<div class="container">
  ...
  <div class="form-group col-md-3">
    ...
    {!! Form::date('fecha',$muestra->hora, ['placeholder' =>'Selecciona la fecha','class' => 'form-control'],"");!!}
  </div>
  <div class="form-group col-md-2">
    {!!Form::label('hora', 'Hora');!!} 
    {!! Form::time('hora',$muestra->hora->format('H:i'), ['placeholder' =>'selecciona la hora','class' => 'form-control'],"");!!}
  </div>
