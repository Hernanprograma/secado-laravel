...
<div class="form-group col-md-3">
      {!!Form::label('fecha', 'Fecha');!!} 
       {!! Form::date('fecha',null, ['placeholder' =>'lectura en m³','class' => 'form-control'],"");!!}
    </div>
    <div class="form-group col-md-2">
      {!!Form::label('hora', 'Hora');!!} 
       {!! Form::time('hora',null, ['placeholder' =>'lectura en m³','class' => 'form-control'],"");!!}
    </div>

    <div class="form-group col-md-2 ">
      {!!Form::label('caudal', 'Caudal');!!}
      {!! Form::text('caudal',null, ['placeholder' =>'lectura en m³','class' => 'form-control'],"");!!}
    </div>

    <div class="form-group col-md-2">
      {!!Form::label('totalizado', 'Totalizado');!!} 
      {!! Form::text('totalizado',null, ['placeholder' =>'Caudal total','class' => 'form-control'],"");!!}
    </div>
    <div class="form-group col-md-3">
